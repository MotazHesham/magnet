...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.storeWithdrawRequest.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-StoreWithdrawRequest">
            <thead>
                <tr>
                    <th width="10">
