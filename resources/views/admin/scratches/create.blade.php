...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.scratch.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.scratches.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('expiration_days') ? 'is-invalid' : '' }}" type="number" name="expiration_days" id="expiration_days" value="{{ old('expiration_days', '') }}" step="1" required>
