...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.scratch.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Scratch">
            <thead>
                <tr>
                    <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.scratches.index') }}",
    columns: [
...
{ data: 'expiration_days', name: 'expiration_days' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Scratch').DataTable(dtOverrideGlobals);
