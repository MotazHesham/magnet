...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.customerPoint.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.customer-points.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_quantity') ? 'is-invalid' : '' }}" type="number" name="product_quantity" id="product_quantity" value="{{ old('product_quantity', '') }}" step="1" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('converted') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="converted" id="converted" value="1" {{ old('converted', 0) == 1 ? 'checked' : '' }}>
