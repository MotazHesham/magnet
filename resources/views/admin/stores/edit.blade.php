...
@section('content')
    <form method="POST" action="{{ route('admin.stores.update', [$store->id]) }}" enctype="multipart/form-data">
        ...
        <input type="hidden" name="latitude" value="{{ $store->latitude }}" id="latitude">
        <input type="hidden" name="longitude" value="{{ $store->longitude }}" id="longitude">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control {{ $errors->has('store_type') ? 'is-invalid' : '' }}"
                                    ...
                                    @foreach (App\Models\Store::STORE_TYPE_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('store_type', $store->store_type) === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description"
                                    id="description">{{ old('description', $store->description) }}</textarea>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control select2 {{ $errors->has('city') ? 'is-invalid' : '' }}"
                                    ...
                                    @foreach ($cities as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('city_id') ? old('city_id') : $store->city->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('city'))
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control {{ $errors->has('identity_num') ? 'is-invalid' : '' }}"
                                    ...
                                    value="{{ old('identity_num', $store->identity_num) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input
                                    ...
                                    value="{{ old('commerical_register_num', $store->commerical_register_num) }}">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-control select2 {{ $errors->has('categories') ? 'is-invalid' : '' }}"
                                    ...
                                    @foreach ($categories as $id => $category)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('categories', [])) || $store->categories->contains($id) ? 'selected' : '' }}>
                                            {{ $category }}</option>
                                    @endforeach
                                </select>
