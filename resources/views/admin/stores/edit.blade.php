    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.stores.update", [$store->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('store_type') ? 'is-invalid' : '' }}" name="store_type" id="store_type">
                    ...
                    @foreach(App\Models\Store::STORE_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('store_type', $store->store_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city_id" id="city_id">
                    @foreach($cities as $id => $entry)
                        <option value="{{ $id }}" {{ (old('city_id') ? old('city_id') : $store->city->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('city'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('store_email') ? 'is-invalid' : '' }}" type="email" name="store_email" id="store_email" value="{{ old('store_email', $store->store_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identity_num') ? 'is-invalid' : '' }}" type="text" name="identity_num" id="identity_num" value="{{ old('identity_num', $store->identity_num) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('commerical_register_num') ? 'is-invalid' : '' }}" type="text" name="commerical_register_num" id="commerical_register_num" value="{{ old('commerical_register_num', $store->commerical_register_num) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax_number') ? 'is-invalid' : '' }}" type="text" name="tax_number" id="tax_number" value="{{ old('tax_number', $store->tax_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rating') ? 'is-invalid' : '' }}" type="number" name="rating" id="rating" value="{{ old('rating', $store->rating) }}" step="0.01">
