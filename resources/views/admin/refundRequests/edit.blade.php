    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.refund-requests.update", [$refundRequest->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('refund_amount') ? 'is-invalid' : '' }}" type="number" name="refund_amount" id="refund_amount" value="{{ old('refund_amount', $refundRequest->refund_amount) }}" step="0.01">
