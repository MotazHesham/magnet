    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-categories.update", [$productCategory->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order_level') ? 'is-invalid' : '' }}" type="number" name="order_level" id="order_level" value="{{ old('order_level', $productCategory->order_level) }}" step="1" required>
