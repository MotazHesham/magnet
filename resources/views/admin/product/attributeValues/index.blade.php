...
@can('attribute_value_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success-light rounded-pill" href="{{ route('admin.attribute-values.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-AttributeValue">
            <thead>
                <tr>
                    <th width="10">
...
{ data: 'id', name: 'id' },
{ data: 'attribute_name', name: 'attribute.name' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-AttributeValue').DataTable(dtOverrideGlobals);
