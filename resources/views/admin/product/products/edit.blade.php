...
@section('content')
    <form method="POST" action="{{ route('admin.products.update') }}" enctype="multipart/form-data" id="update_product"> 
        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select
                                    ...
                                    name="product_categories[]" id="product_categories" multiple>
                                    @foreach ($product_categories as $id => $product_category)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('product_categories', [])) || $product->product_categories->contains($id) ? 'selected' : '' }}>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input class="form-control {{ $errors->has('tags') ? 'is-invalid' : '' }}" type="text"
                                    name="tags[]" value="{{ $product->tags }}" id="tags" placeholder="add tags ..."
                                    data-role="tagsinput">
                                @if ($errors->has('tags'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('tags') }}
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                <div class="form-check {{ $errors->has('refundable') ? 'is-invalid' : '' }}">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="refundable" id="refundable"
                                        value="1"
                                        {{ $product->refundable || old('refundable', 0) === 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group col-md-3">
                                <div class="form-check {{ $errors->has('featured') ? 'is-invalid' : '' }}">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="featured" id="featured"
                                        value="1"
                                        {{ $product->featured || old('featured', 0) === 1 ? 'checked' : '' }}>
                                    <label class="form-check-label"
                            ...
                            <div class="form-group col-md-3">
                                <div class="form-check {{ $errors->has('published') ? 'is-invalid' : '' }}">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="published" id="published"
                                        value="1"
                                        {{ $product->published || old('published', 0) === 1 ? 'checked' : '' }}>
                                    <label class="form-check-label"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control {{ $errors->has('unit_price') ? 'is-invalid' : '' }}"
                                    ...
                                    value="{{ old('unit_price', $product->unit_price) }}" step="0.01" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control {{ $errors->has('discount_type') ? 'is-invalid' : '' }}"
                                    ...
                                    @foreach (App\Models\Product::DISCOUNT_TYPE_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('discount_type', $product->discount_type) === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-control select2 {{ $errors->has('colors') ? 'is-invalid' : '' }}"
                                    ...
                                    @foreach ($colors as $key => $label)
                                        <option value="{{ $key }}" data-color="{{ $key }}"
                                            @if ($product->colors != null && in_array($key, json_decode($product->colors, true))) selected @endif>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-control select2 {{ $errors->has('attributes') ? 'is-invalid' : '' }}"
                                    ...
                                    @foreach ($attributes as $key => $label)
                                        <option value="{{ $key }}"
                                            @if ($product->attributes != null && in_array($key, json_decode($product->attributes, true))) selected @endif>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
...
@section('scripts')
    <script>
        ...
        function update_attribute_options(){
            ...
            $.ajax({
                type: "POST",
                url: '{{ route('admin.products.attribute_options_edit') }}',
                data: {
