...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.commissionHistory.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.commission-histories.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('admin_commission') ? 'is-invalid' : '' }}" type="number" name="admin_commission" id="admin_commission" value="{{ old('admin_commission', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('store_earning') ? 'is-invalid' : '' }}" type="number" name="store_earning" id="store_earning" value="{{ old('store_earning', '') }}" step="0.01" required>
