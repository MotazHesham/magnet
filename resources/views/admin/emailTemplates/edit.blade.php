    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.email-templates.update", [$emailTemplate->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user_type') ? 'is-invalid' : '' }}" type="text" name="user_type" id="user_type" value="{{ old('user_type', $emailTemplate->user_type) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identifier') ? 'is-invalid' : '' }}" type="text" name="identifier" id="identifier" value="{{ old('identifier', $emailTemplate->identifier) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_type') ? 'is-invalid' : '' }}" type="text" name="email_type" id="email_type" value="{{ old('email_type', $emailTemplate->email_type) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('default_text') ? 'is-invalid' : '' }}" name="default_text" id="default_text">{!! old('default_text', $emailTemplate->default_text) !!}</textarea>
