    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sms-templates.update", [$smsTemplate->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identifier') ? 'is-invalid' : '' }}" type="text" name="identifier" id="identifier" value="{{ old('identifier', $smsTemplate->identifier) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('sms_body') ? 'is-invalid' : '' }}" name="sms_body" id="sms_body">{!! old('sms_body', $smsTemplate->sms_body) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('templateid') ? 'is-invalid' : '' }}" type="text" name="templateid" id="templateid" value="{{ old('templateid', $smsTemplate->templateid) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('status') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="status" id="status" value="1" {{ $smsTemplate->status || old('status', 0) === 1 ? 'checked' : '' }}>
