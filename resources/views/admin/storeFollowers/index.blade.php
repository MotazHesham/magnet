...
@section('content')
@can('store_follower_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.store-followers.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.storeFollower.title_singular') }}
            </a>
        </div>
    </div>
@endcan
...
@can('store_follower_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.store-followers.massDestroy') }}",
