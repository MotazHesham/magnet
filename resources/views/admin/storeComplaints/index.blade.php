...
@section('content')
@can('store_complaint_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.store-complaints.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.storeComplaint.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.storeComplaint.title_singular') }} {{ trans('global.list') }}
    </div>
...
@can('store_complaint_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.store-complaints.massDestroy') }}",
