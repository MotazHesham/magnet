...
@section('content')
@can('product_favorite_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.product-favorites.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.productFavorite.title_singular') }}
            </a>
        </div>
    </div>
@endcan
...
@can('product_favorite_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.product-favorites.massDestroy') }}",
