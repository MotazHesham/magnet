    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.customers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wallet_balance') ? 'is-invalid' : '' }}" type="number" name="wallet_balance" id="wallet_balance" value="{{ old('wallet_balance', '') }}" step="0.01">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('can_scratch') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="can_scratch" id="can_scratch" value="1" {{ old('can_scratch', 0) == 1 || old('can_scratch') === null ? 'checked' : '' }}>
